    ...
    >
      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <button
          ...
          className="shrink-0 rounded-lg bg-red-500 p-1.5 text-white shadow-sm transition-all duration-200 hover:bg-red-600 active:scale-[0.92] dark:bg-red-600 dark:hover:bg-red-500"
          title="Delete note"
        >
